...
{
  auto client = node->create_client<zivid_interfaces::srv::DetectMarkers>("detect_markers");
...
int main(int argc, char * argv[])
{
  ...
  auto request = std::make_shared<zivid_interfaces::srv::DetectMarkers::Request>();
