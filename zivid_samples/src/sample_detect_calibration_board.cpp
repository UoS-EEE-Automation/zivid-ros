  ...
  const zivid_interfaces::msg::DetectionResultCalibrationBoard & msg)
{
  ...
  switch (msg.status) {
    ...
    case DetectionResultCalibrationBoard::STATUS_MULTIPLE_VALID_FIDUCIAL_MARKER_DETECTED:
      return "STATUS_MULTIPLE_VALID_FIDUCIAL_MARKER_DETECTED";
...
{
  auto client =
    node->create_client<zivid_interfaces::srv::DetectCalibrationBoard>("detect_calibration_board");
...
int main(int argc, char * argv[])
{
  ...
  auto request = std::make_shared<zivid_interfaces::srv::DetectCalibrationBoard::Request>();
